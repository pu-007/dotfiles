...
# Note: custom completions at ~/.config/zsh/completions/ override system ones.
source "$HOME/.local/share/zinit/zinit.git/zinit.zsh"
autoload -U compinit && compinit

# Completion auto-loaded from ~/.config/zsh/completions/_wots (generated by just build)
